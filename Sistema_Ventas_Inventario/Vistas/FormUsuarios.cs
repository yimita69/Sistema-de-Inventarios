       ...
       MetodosUsuario metodosUsuario;
        ...
        public void FormatoTablaUsuarios(DataTable datos)
        {
            try
            {
                ...
                // ----------------- ESTILO VISUAL DGVUsuarios -----------------


// Bordes y alineación más limpios
foreach (DataGridViewColumn col in DGVUsuarios.Columns)
{
    ...
    col.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
        ...
        private void DGVUsuarios_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                if (row.Cells["ESTADO"].Value != null && row.Cells["ESTADO"].Value.ToString() == "1")
                {
                    row.DefaultCellStyle.BackColor = Color.FromArgb(210, 225, 240);
